...
class Controler:
    ...
    def has_element(self, element):
        now_screen = UIBlock(count_dict=self.ui_element_op_counts, xml_str=self.operator.dump_screen_xml())
    ...
    def clear_background(self):
        ...
        # print(content)
        ui = UIBlock(count_dict=self.ui_element_op_counts, xml_str=content)
    ...
    # app自动遍历
    def app_dfs(self, screen: UIBlock, curr_depth: int) -> None:
    ...
    def run(self):
        ...
        for _ in range(self.max_loop):
            ...
            sleep(3)
            # 获取第一个界面，开始遍历
            screen = UIBlock(count_dict=self.ui_element_op_counts, xml_str=self.operator.dump_screen_xml())
